...
### Optuna Example (based on [here](https://github.com/optuna/optuna-examples/blob/main/pytorch/pytorch_lightning_simple.py))
```python
import argparse
import time
import sys
...
if __name__ ==  "__main__":
    ...
    parser.add_argument("-p","--pruning",
                        action = "store_true",
                        help = "Activate the pruning feature.", 
                        "`MedianPruner` stops unpromising trials at the early stages of training.")
